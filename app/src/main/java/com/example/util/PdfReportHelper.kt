    ...
    fun generateAndPrintShiftReport(
        ...
        val html = """
            ...
            <body>
                <div class="header">
                    <h2>$storeName</h2>
                    <p style="margin: 4px 0;"><strong>LAPORAN SERAH TERIMA SHIFT KASIR</strong> ${if (shiftCode.isNotBlank()) "($shiftCode)" else ""}</p>
                    <p style="margin: 2px 0;">Kasir: <strong>$kasirName</strong> | Waktu Cetak: $nowStr</p>
                    ${if (waktuBukaStr.isNotBlank()) "<p style='margin: 2px 0;'>Sesi Shift: <strong>$waktuBukaStr</strong> s/d <strong>${waktuTutupStr ?: "Sedang Berjalan"}</strong></p>" else ""}
                </div>
        ...
        val html = """
            ...
            <body>
                <div class="header">
                    ...
                    <div class="badge">Versi v6.7.5 — Official Stable Release</div>
                    <p style="margin-top:8px;">Tanggal Rilis: 16 Agustus 2026 | Developer: Eka Ilaika</p>
                </div>

                <div class="card">
                    <div class="section-title">🚀 Ringkasan Rilis v6.7.5</div>
                    <p style="font-size:12px; margin:0;">Pembaruan komprehensif sistem kasir <strong>KasiGR-atis POS</strong> dengan integrasi penuh modul Shift Kerja Kasir, pembukuan kas laci, ekspor cetak dokumen PDF resmi A4, dan penyelarasan buku panduan operasional.</p>
                </div>

                <div class="card">
                    <div class="section-title">✨ Fitur Utama & Pembaruan Sistem (Patch Notes)</div>
                    <ul>
                        <li><span class="highlight">⏱️ Manajemen Shift Kasir & Rekonsiliasi Kas</span>: Fitur Buka & Tutup Shift, pencatatan modal awal uang kembalian di laci kasir, pencatatan kas keluar operasional shift, dan deteksi selisih kas fisik riil secara otomatis.</li>
                        <li><span class="highlight">📄 Seluruh Dokumen Siap Cetak / Simpan PDF</span>: Ekspor dokumen resmi ukuran A4 siap cetak dan simpan untuk Laporan Shift Kasir, Laporan Finansial Toko, Lembar Resep HPP & BOM, Laporan Aging Piutang Kasbon, Struk Transaksi, dan Patch Notes.</li>
                        <li><span class="highlight">💾 Pencadangan & Pemulihan Database Lengkap</span>: Sistem Room SQLite Backup & Restore format JSON mencakup seluruh tabel (Profil Toko, Rekening/QRIS, Menu Produk, BOM Bahan Baku, Transaksi Penjualan, Kasbon, dan Riwayat Shift Kasir).</li>
                        <li><span class="highlight">🛒 Operasional Kasir Cepat & Bill Gantung</span>: Pemesanan cepat Dine-In / Takeaway, Varian & Topping, fitur Tunda Pesanan (Bill Gantung), serta verifikasi pembayaran multi-metode (Tunai, QRIS, Transfer, Kasbon).</li>
                        <li><span class="highlight">🥣 Kalkulator HPP & Resep BOM Presisi</span>: Hitung modal bahan baku per unit menu kulakan beserta persentase waste dan rekomendasi margin jual 35% & 50%.</li>
                        <li><span class="highlight">🔒 Keamanan Multirole & Buku Panduan</span>: Pemisahan hak akses Kasir dan Pemilik Toko ber-PIN, dilengkapi Buku Panduan Operasional yang diperbarui.</li>
                    </ul>
                </div>
